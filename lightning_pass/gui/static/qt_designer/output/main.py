...
class Ui_lightning_pass(object):
    def setupUi(self, lightning_pass):
        ...
        self.gridLayout_10.addWidget(self.reset_token_lbl, 0, 0, 1, 2)
        ...
        self.reset_pass_lbl = QtWidgets.QLabel(self.reset_password)
        font = QtGui.QFont()
        font.setFamily("Segoe Print")
        font.setPointSize(26)
        self.reset_pass_lbl.setFont(font)
        self.reset_pass_lbl.setObjectName("reset_pass_lbl")
        self.gridLayout_11.addWidget(self.reset_pass_lbl, 0, 0, 1, 2)
        self.reset_pass_new_pass_lbl = QtWidgets.QLabel(self.reset_password)
        font = QtGui.QFont()
        font.setFamily("Segoe UI Light")
        font.setPointSize(10)
        self.reset_pass_new_pass_lbl.setFont(font)
        self.reset_pass_new_pass_lbl.setObjectName("reset_pass_new_pass_lbl")
        self.gridLayout_11.addWidget(self.reset_pass_new_pass_lbl, 1, 0, 1, 1)
        self.reset_pass_conf_new_lbl = QtWidgets.QLabel(self.reset_password)
        font = QtGui.QFont()
        font.setFamily("Segoe UI Light")
        font.setPointSize(10)
        self.reset_pass_conf_new_lbl.setFont(font)
        self.reset_pass_conf_new_lbl.setObjectName("reset_pass_conf_new_lbl")
        self.gridLayout_11.addWidget(self.reset_pass_conf_new_lbl, 2, 0, 1, 1)
        self.reset_pass_confirm_btn = QtWidgets.QPushButton(self.reset_password)
        font = QtGui.QFont()
        font.setFamily("Segoe UI Light")
        font.setPointSize(10)
        self.reset_pass_confirm_btn.setFont(font)
        self.reset_pass_confirm_btn.setAutoDefault(False)
        self.reset_pass_confirm_btn.setDefault(True)
        self.reset_pass_confirm_btn.setObjectName("reset_pass_confirm_btn")
        self.gridLayout_11.addWidget(self.reset_pass_confirm_btn, 3, 0, 1, 2)
        self.reset_pass_main_btn = QtWidgets.QPushButton(self.reset_password)
        font = QtGui.QFont()
        font.setFamily("Segoe UI Light")
        font.setPointSize(10)
        self.reset_pass_main_btn.setFont(font)
        self.reset_pass_main_btn.setObjectName("reset_pass_main_btn")
        self.gridLayout_11.addWidget(self.reset_pass_main_btn, 3, 2, 1, 1)
        self.reset_pass_new_pass_line = QtWidgets.QLineEdit(self.reset_password)
        font = QtGui.QFont()
        font.setFamily("Segoe UI Light")
        font.setPointSize(10)
        ...
        self.reset_pass_conf_new_line = QtWidgets.QLineEdit(self.reset_password)
        font = QtGui.QFont()
        font.setFamily("Segoe UI Light")
        font.setPointSize(10)
        ...
        self.gridLayout_13.addWidget(self.master_pass_main_lbl, 0, 0, 1, 2)
    ...
    def retranslateUi(self, lightning_pass):
        ...
        self.reset_pass_lbl.setText(_translate("lightning_pass", "Reset Password"))
        self.reset_pass_new_pass_lbl.setText(
            _translate("lightning_pass", "New Password:")
        )
        self.reset_pass_conf_new_lbl.setText(
            _translate("lightning_pass", "Confirm New Password")
        )
        self.reset_pass_confirm_btn.setText(_translate("lightning_pass", "Confirm"))
        self.reset_pass_main_btn.setText(_translate("lightning_pass", "Main Menu"))
        self.reset_pass_new_pass_line.setPlaceholderText(
            _translate("lightning_pass", "Enter your new password.")
        )
        self.reset_pass_conf_new_line.setPlaceholderText(
